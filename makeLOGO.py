...
def randomkmer_typeEF(PWM):
    ...
    for pos in range(len(PWM['A'])):
        ...
        if die<=PWM['A'][pos]*100000:
            ...
            kmer+='G'
        else: #die<=(PWM['A'][pos]+PWM['C'][pos]+PWM['G'][pos]+PWM['T'][pos])*100000:
            kmer+='T'
...
def main():
    ...
    %s [options]
        ...
        --typeEF            convert the modified base to E and the complementary base to F, default is False (optional) #use typeEF for normal MEME
